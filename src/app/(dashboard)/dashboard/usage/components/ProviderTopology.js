...
function ProviderNode({ data }) {
  ...
  return (
    <div
      className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg border-2 transition-[border-color,background-color,box-shadow] duration-300 bg-bg"
      style={{
...
// Center LiteRouter node — pulse/glow on card only (no expanding rings)
