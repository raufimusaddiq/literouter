...
// Resolve fixture paths against the repo, not the vitest cwd. `npm --prefix
// tests test` runs with cwd=tests/, so a bare path.resolve("src/...") would
// look for tests/src/... and fail with ENOENT.
