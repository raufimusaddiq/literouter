...
LiteRouterはすべてのプロバイダーに対して包括的なクォータトラッキングを提供:
...
**例:**
```
現在: cc/claude-opus-5 → glm/glm-5.1
  80% Claude経由 (良好)
  20% GLM経由 ($12/月)

最適化後: vertex/gemini-3-flash-preview → cc/claude-opus-5 → glm/glm-5.1
  50% Gemini経由 (無料)
