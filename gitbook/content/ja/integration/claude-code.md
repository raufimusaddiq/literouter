...
LiteRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをLiteRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはLiteRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がLiteRouterの設定と一致しているか確認
