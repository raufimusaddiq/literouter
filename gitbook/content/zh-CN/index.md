...
LiteRouter 是一款 AI 模型路由工具,通过智能路由和自动回退机制,最大化你的订阅价值并最小化成本。

---

## 什么是 LiteRouter?

LiteRouter 是一款智能代理,位于你的编码工具(Cursor、Cline、Claude Desktop)与 AI 提供商之间。它会根据配额、成本和可用性,自动将请求路由到最合适的模型。
...
- 使用云端部署(https://ai-staging.investdx.biz.id)
- 从 iPad、手机、任何地方访问
- 没有 localhost 限制
