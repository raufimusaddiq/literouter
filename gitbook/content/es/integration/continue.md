...
Integra LiteRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de LiteRouter desde el [dashboard](https://ai-staging.investdx.biz.id/dashboard)
- LiteRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de LiteRouter
...
```json
{
  "models": [
    ...
    {
      "title": "LiteRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "LiteRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "LiteRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de LiteRouter
...
- Verifica que LiteRouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de LiteRouter
...
- Verifica la latencia de red hacia LiteRouter
