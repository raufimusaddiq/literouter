...
Integra LiteRouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de LiteRouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- LiteRouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de LiteRouter:

**Para LiteRouter local:**
```
http://localhost:20128/v1
```

**Para LiteRouter en la nube:**
```
https://9router.com
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de LiteRouter
...
4. Cline usará LiteRouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando LiteRouter
...
3. Obtén explicaciones potenciadas por IA a través de LiteRouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará LiteRouter para entender el contexto y hacer cambios
...
1. Verifica que LiteRouter esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de LiteRouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de LiteRouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de LiteRouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://ai-staging.investdx.biz.id`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de LiteRouter
...
## Integración con características de LiteRouter

### Enrutamiento de modelos

LiteRouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, LiteRouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de LiteRouter:
