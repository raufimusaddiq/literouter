...
Integra LiteRouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de LiteRouter.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de LiteRouter:
