...
LiteRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

LiteRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a LiteRouter usando estas configuraciones:

**LiteRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de LiteRouter (cc/*, cx/*, glm/*, etc.)
```

**LiteRouter en la nube:**
```
...
**Problema:** No se puede conectar a LiteRouter
```bash
# Verifica si LiteRouter está corriendo
...
**Solución:**
- Verifica que LiteRouter esté corriendo
...
- Verifica la conexión de red a LiteRouter
