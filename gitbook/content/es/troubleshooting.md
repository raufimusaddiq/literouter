...
2. **Usa el fallback con combo:**
   ...
   Ejemplo: cc/claude-opus-5 → glm/glm-5.1 → kr/deepseek-3.2
   ```
...
3. **Agrega un combo de fallback:**
   ...
   Respaldo: glm/glm-5.1 (barato)
   Emergencia: kr/deepseek-3.2 (gratis)
   ```
...
3. **Usa el nivel gratis:**
   ```
   kr/glm-5 (GRATIS)
   vertex/gemini-3.1-pro-preview (GRATIS)
   kr/glm-5 (GRATIS)
   vertex/gemini-3-flash-preview (crédito gratis)
   ```
