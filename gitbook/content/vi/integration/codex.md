...
Tích hợp LiteRouter với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của LiteRouter.
...
LiteRouter cung cấp các model Codex sau:

| Model ID | Mô tả |
|----------|-------------|
| `cx/gpt-5.5` | GPT-5.2 Codex - Phiên bản mới nhất |
| `cx/gpt-5.4` | GPT-5.1 Codex Max - Extended context |
...
1. Xác minh API key đúng trong LiteRouter dashboard
...
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong LiteRouter dashboard
