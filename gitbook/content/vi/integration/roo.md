...
Tích hợp LiteRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
### Connection Failed
- Xác minh LiteRouter đang chạy: `curl http://localhost:20128/health`
