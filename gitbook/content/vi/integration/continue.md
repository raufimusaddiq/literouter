...
Tích hợp LiteRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- LiteRouter API key từ [dashboard](https://ai-staging.investdx.biz.id/dashboard)
- LiteRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model LiteRouter
...
3. Chọn model LiteRouter ưa thích
...
- Kiểm tra LiteRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến LiteRouter
