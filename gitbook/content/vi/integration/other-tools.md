...
LiteRouter tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

LiteRouter cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến LiteRouter bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến LiteRouter
```bash
...
- Kiểm tra kết nối network đến LiteRouter
