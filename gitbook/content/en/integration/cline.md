...
Integrate LiteRouter with Cline VSCode extension to route your AI requests through LiteRouter's intelligent routing system.
...
Set the base URL to your LiteRouter endpoint:

**For Local LiteRouter:**
```
http://localhost:20128/v1
```

**For Cloud LiteRouter:**
```
https://9router.com
```

**Steps:**
1. In the **Base URL** field, enter your LiteRouter endpoint
...
1. In the **Model** dropdown, you can either:
   ...
   - Manually enter the model name from your LiteRouter configuration
...
4. Cline will use LiteRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using LiteRouter
...
3. Get AI-powered explanations through LiteRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use LiteRouter to understand context and make changes
...
2. Verify your LiteRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check LiteRouter logs for any errors
...
1. In Cline settings, set Base URL to: `https://ai-staging.investdx.biz.id`
2. Make sure you have configured your API key in the LiteRouter cloud dashboard
...
## Integration with LiteRouter Features

### Model Routing

LiteRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, LiteRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through LiteRouter dashboard:
- Total requests
- Token usage
- Cost per model
