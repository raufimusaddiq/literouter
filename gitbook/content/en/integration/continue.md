...
Integrate LiteRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- LiteRouter API key from [dashboard](https://ai-staging.investdx.biz.id/dashboard)
- LiteRouter running (local or cloud)
...
### 2. Add LiteRouter Model Configuration
...
3. Choose your preferred LiteRouter model
...
- Check network latency to LiteRouter
