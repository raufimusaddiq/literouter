...
LiteRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

LiteRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to LiteRouter using these settings:

**Local LiteRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any LiteRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to LiteRouter
```bash
...
- Check network connection to LiteRouter
