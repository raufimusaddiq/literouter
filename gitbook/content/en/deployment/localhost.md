...
Run LiteRouter on your local machine for development and personal use.

---

## 📦 Installation

Install LiteRouter globally via npm:
...
Start LiteRouter with a single command:
...
Press `Ctrl+C` in the terminal where LiteRouter is running.
