...
The same matrix applies to literouter's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside literouter;
  literouter only forwards the catalog-advertised reasoning override.
