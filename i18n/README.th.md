...
<div align="center">
  <img src="../images/9router.png?1" alt="แดชบอร์ด LiteRouter" width="800"/>
...
LiteRouter ทำงานได้อย่างราบรื่นกับเครื่องมือเขียนโค้ด AI ทุกประเภท:
...
Headroom เป็นตัวเลือกและทำงานแยกกัน LiteRouter เรียก endpoint `/v1/compress` ของ Headroom จากนั้นยังคงเลือกเส้นทาง, fallback, auth และติดตามการใช้งานตามปกติ:
...
ถ้า Headroom ดับหรือคืน error, LiteRouter จะ fail open และส่งคำขอต้นฉบับ
...
- เครื่องมือ CLI ของคุณส่งรูปแบบ OpenAI → LiteRouter แปลง → ผู้ให้บริการได้รับรูปแบบต้นฉบับ
...
<details>
<summary><b>💳 LiteRouter เก็บเงินฉันหรือไม่?</b></summary>

**ไม่.** LiteRouter เป็นซอฟต์แวร์ฟรีแบบ open source ที่ทำงานบนเครื่องของคุณเอง มันไม่มีวันเรียกเก็บเงินจากคุณ

**คุณจ่ายเงินเฉพาะ:**
- ✅ **ผู้ให้บริการสมาชิก** (Claude Code $20/เดือน, Codex $20-200/เดือน) → จ่ายตรงให้พวกเขาบนเว็บไซต์ของพวกเขา
- ✅ **ผู้ให้บริการราคาถูก** (GLM, MiniMax) → จ่ายตรงให้พวกเขา, LiteRouter แค่เลือกเส้นทางคำขอของคุณ
- ❌ **ตัว LiteRouter เอง** → **ไม่มีวันเรียกเก็บเงินใดๆ ทั้งสิ้น**

LiteRouter เป็น proxy/router ท้องถิ่น มันไม่มีบัตรเครดิตของคุณ, ไม่สามารถส่งใบแจ้งหนี้ได้ และไม่มีระบบชำระเงิน เป็นซอฟต์แวร์ฟรีทั้งหมด
...
LiteRouter แค่เลือกเส้นทางคำขอของคุณไปหาพวกเขา — ไม่มี "กับดัก" หรือการเรียกเก็บเงินในอนาคต เป็นบริการที่ฟรีจริงๆ และ LiteRouter ทำให้ใช้งานง่ายด้วยการรองรับ fallback
...
3. **ใช้ผู้ให้บริการสมาชิก** ก็ต่อเมื่อมีอยู่แล้ว:
   - LiteRouter ช่วยเพิ่มประสิทธิภาพมูลค่าของพวกเขาผ่านการติดตามโควตา
...
ขอขอบคุณผู้มีส่วนร่วมทุกคนที่ช่วยทำให้ LiteRouter ดียิ่งขึ้น!
