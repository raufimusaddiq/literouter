<div align="center">
  <img src="../images/9router.png?1" alt="Tableau de bord LiteRouter" width="800"/>

  # LiteRouter - Routeur IA GRATUIT et économiseur de tokens
...
LiteRouter n'est pas une réécriture. C'est 9Router en amont, avec un flag runtime
`MINIMAL_PROFILE`, un petit cache de hot-path, et les sous-systèmes annexes désactivés.
Le moteur de routage, le registre de providers, la matrice de transports, le tableau de bord
et le schéma SQLite sont inchangés — c'est pourquoi les correctifs amont restent cherry-pickables.

### Ce qui change réellement

| Zone | 9Router / LiteRouter |
| --- | --- |
| Profil runtime | complet | `MINIMAL_PROFILE=true` |
| Sync du catalogue | en arrière-plan | `MODEL_CATALOG_SYNC=off` |
...
Upstream réel, burst (kn/deepseek-v4-1-flash, n=24, 8 concurrent):
...
| Conteneur | RSS au repos | RSS après burst | Limite |
| --- | --- | --- | --- |
...
<table>
  ...
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với LiteRouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="LiteRouter + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>LiteRouter + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>LiteRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="LiteRouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>LiteRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with LiteRouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + LiteRouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup LiteRouter 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy LiteRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy LiteRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **Vous avez réalisé une vidéo sur LiteRouter ?** Envoyez une [Pull Request](https://github.com/decolua/9router/pulls) en ajoutant votre vidéo à cette section — nous la fusionnerons !

---

## 🛠️ Outils CLI pris en charge

LiteRouter fonctionne parfaitement avec tous les principaux outils de codage IA :
  ...
  <table>
    <tr>
      <td align="center" width="150">
        ...
        <b>Kiro AI</b><br/>
        <sub>GLM 5 + DeepSeek 3.2 + Qwen3 Coder Next<br/>GRATUIT illimité</sub>
      </td>
      <td align="center" width="150">
...
Headroom est optionnel et s'exécute séparément. LiteRouter appelle l'endpoint local `/v1/compress` de Headroom, puis conserve le routage, le repli, l'authentification et le suivi d'utilisation normaux :

```
Client → LiteRouter → Headroom /v1/compress → LiteRouter → fournisseur
```
...
Si Headroom est indisponible ou renvoie une erreur, LiteRouter bascule en mode dégradé et envoie la requête originale.
...
Combo : "my-coding-stack"
  1. cc/claude-opus-5        (votre abonnement)
  2. glm/glm-5.1               (sauvegarde économique, $0.6/1M)
  3. kr/glm-5       (repli gratuit)
...
- Votre outil CLI envoie le format OpenAI → LiteRouter le traduit → Le fournisseur reçoit le format natif
...
> LiteRouter lui-même **ne vous facture jamais** quoi que ce soit. Vous ne payez que les fournisseurs directement (si vous utilisez des services payants).
>
> **Exemple :** Si votre tableau de bord affiche "coût total de 290 $" alors que vous utilisez les modèles gratuits, cela représente
> ce que vous auriez payé en utilisant des API payantes directement. Votre coût réel = **0 $** (Kiro est gratuit dans la limite).
>
> Considérez-le comme un "suivi d'économies" qui montre combien vous économisez en utilisant des modèles gratuits ou
> en routant via LiteRouter !
...
| **💰 BON MARCHÉ**     | GLM-5.1 / GLM-5       | 0,6 $/1M        | Quotidienne 10 h          | Sauvegarde économique                      |
|                        | MiniMax M2.7          | 0,2 $/1M        | Fenêtre de 5 heures       | L'option la moins chère                    |
|                        | Kimi K2.5             | 9 $/mois forfait | 10M tokens/mois          | Coût prévisible                            |
| **🆓 GRATUIT**         | Kiro AI               | 0 $             | Illimité                  | GLM 5 + DeepSeek 3.2 + Qwen3 Coder Next gratuits      |
...
### 📊 Comprendre les coûts et la facturation de LiteRouter

**La réalité de la facturation de LiteRouter :**

✅ **Le logiciel LiteRouter = GRATUIT pour toujours** (open source, ne facture jamais)
...
✅ **Les fournisseurs GRATUITS restent GRATUITS** (Kiro, OpenCode Free, Vertex = 0 $ illimité)
❌ **LiteRouter n'envoie jamais de factures** et ne débite pas votre carte
...
- **Fournisseurs bon marché** (GLM, MiniMax) : Payez-les directement, LiteRouter se contente de router
- **Fournisseurs GRATUITS** (Kiro, OpenCode Free, Vertex) : Vraiment gratuits pour toujours, sans frais cachés
- **LiteRouter** : Ne facture jamais rien, jamais
...
Combo : "maximize-claude"
  1. cc/claude-opus-5        (utilisez l'abonnement à fond)
  2. glm/glm-5.1               (sauvegarde économique quand le quota est épuisé)
  3. kr/glm-5      (repli gratuit d'urgence)
...
```
Combo : "free-forever"
  1. kr/glm-5      (Claude 4.5 gratuit illimité)
...
```
Combo : "always-on"
  1. cc/claude-opus-5        (meilleure qualité)
...
```
Combo : "openclaw-free"
  1. kr/glm-5      (Claude 4.5 gratuit)
  2. kr/glm-5                  (GLM-5 gratuit)
  3. kr/deepseek-3.2           (MiniMax gratuit)
...
<details>
<summary><b>💳 LiteRouter me facturera-t-il ?</b></summary>

**Non.** LiteRouter est un logiciel gratuit et open source qui s'exécute sur votre propre ordinateur. Il ne vous facture jamais rien.

**Vous ne payez que :**

- ✅ **Fournisseurs par abonnement** (Claude Code 20 $/mois, Codex 20 à 200 $/mois) → Payez-les directement sur leurs sites web
- ✅ **Fournisseurs bon marché** (GLM, MiniMax) → Payez-les directement, LiteRouter route simplement vos requêtes
- ❌ **LiteRouter lui-même** → **Ne facture jamais rien, jamais**

LiteRouter est un proxy/routeur local. Il n'a pas votre carte bancaire, ne peut pas envoyer de factures et ne possède aucun système de facturation. C'est un logiciel entièrement gratuit.
...
- **Kiro AI** : GLM 5 + DeepSeek 3.2 + Qwen3 Coder Next gratuits et illimités via AWS Builder ID / Google / GitHub OAuth
...
LiteRouter se contente de router vos requêtes vers eux — il n'y a pas de "piège" ni de facturation future. Ce sont de véritables services gratuits, et LiteRouter les rend faciles à utiliser avec le support du repli.
...
1. **Commencez avec un combo 100 % gratuit :**
   ...
   ```
   1. vertex/gemini-3-flash-preview ($300 de crédits GCP)
   2. kr/deepseek-3.2 (gratuit via Kiro)
   3. vertex/gemini-2.5-flash ($300 de crédits GCP)
   ```
...
2. **Ajoutez une sauvegarde économique** uniquement si nécessaire :
   ...
   ```
   4. glm/glm-5.1 (0,6 $/1M de tokens)
   ```
...
3. **Utilisez les fournisseurs par abonnement en dernier :**
   ...
   - LiteRouter vous aide à maximiser leur valeur grâce au suivi de quota
...
Le repli intelligent de LiteRouter évite les frais surprises :
...
**Vous gardez le contrôle :** Définissez des limites de dépenses par fournisseur dans le tableau de bord, et LiteRouter les respecte.
...
**Astuce pro :** Utilisez Opus pour les tâches complexes et Sonnet pour la vitesse. LiteRouter suit le quota par modèle !
...
### GLM-5.1 / GLM-5 (réinitialisation quotidienne, 0,6 $/1M)
...
**Utilisation :** `glm/glm-5.1`, `glm/glm-5`, `glm/glm-5.1`
...
**Utilisation :** `minimax/MiniMax-M2.7`
...
**Utilisation :** `kimi/kimi-k2.5`, `kimi/kimi-k2.5`
...
### Kiro AI (GLM 5 + DeepSeek 3.2 + Qwen3 Coder Next GRATUIT)
...
Nom : premium-coding
Modèles :
  1. cc/claude-opus-5 (Abonnement principal)
  2. glm/glm-5.1 (Sauvegarde économique, 0,6 $/1M)
...
> **Remarque :** OpenClaw ne fonctionne qu'avec un LiteRouter local. Utilisez `127.0.0.1` au lieu de `localhost` pour éviter les problèmes de résolution IPv6.
...
- Ajoutez le combo : `cc/claude-opus-5 → glm/glm-5.1 → kr/glm-5`

**Token OAuth expiré**

- Renouvelé automatiquement par LiteRouter
...
Merci à tous les contributeurs qui ont contribué à améliorer LiteRouter !
...
**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — Un fork TypeScript complet de LiteRouter. Ajoute plus de 36 fournisseurs, un repli automatique à 4 niveaux, des API multimodales (images, embeddings, audio, TTS), un disjoncteur, un cache sémantique, des évaluations de LLM et un tableau de bord soigné. Plus de 368 tests unitaires. Disponible via npm et Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — économiseur de tokens en Rust. LiteRouter porte son pipeline de compression en JS → **−20 à 40 % de tokens d'entrée** sur chaque requête.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) par **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. LiteRouter adapte son prompt → **−65 % de tokens de sortie**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) par **[@DietrichGebert](https://github.com/DietrichGebert)** — compétence de _"dev sénior fainéant"_. LiteRouter injecte sa hiérarchie YAGNI-d'abord → **moins de tokens, moins de code, des diffs plus courts**.

Un immense merci à ces auteurs — sans leur travail, les fonctionnalités d'économie de tokens de LiteRouter n'existeraient pas. Mettez-leur une ⭐ sur GitHub !
