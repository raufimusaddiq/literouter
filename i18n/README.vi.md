<div align="center">
  <img src="../images/9router.png?1" alt="Bảng điều khiển LiteRouter" width="800"/>
...
**LiteRouter giải quyết vấn đề này:**
...
### 📺 Hướng dẫn thiết lập hoàn chỉnh - LiteRouter + Claude Code MIỄN PHÍ

[![Thiết lập LiteRouter + Claude Code](https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg)](https://www.youtube.com/watch?v=raEyZPg5xE0)

**🎬 Xem hướng dẫn từng đầy đủ:**
- ✅ Cài đặt & thiết lập LiteRouter
...
LiteRouter hoạt động liền mạch với tất cả các công cụ code AI chính:
...
- Công cụ CLI của bạn gửi định dạng OpenAI → LiteRouter dịch chuyển → Nhà cung cấp nhận định dạng gốc
...
### 📊 Hiểu về Chi phí & Thanh toán của LiteRouter

**Thực tế Thanh toán LiteRouter:**
...
<details>
<summary><b>💳 Tôi có bị LiteRouter tính phí không?</b></summary>

**Không.** LiteRouter là phần mềm miễn phí, mã nguồn mở chạy trên máy tính của chính bạn. Nó không bao giờ tính phí bạn bất cứ thứ gì.

**Bạn chỉ trả tiền:**
- ✅ **Nhà cung cấp gói đăng ký** (Claude Code $20/tháng, Codex $20-200/tháng) → Trả tiền trực tiếp cho họ trên website của họ
- ✅ **Nhà cung cấp giá rẻ** (GLM, MiniMax) → Trả tiền trực tiếp cho họ, LiteRouter chỉ định tuyến yêu cầu của bạn
- ❌ **Bản thân LiteRouter** → **Không bao giờ tính phí bất cứ thứ gì, ever**

LiteRouter là một proxy/router cục bộ. Nó không cóẻ tín dụng của bạn, không thể gửi hóa đơn và không có hệ thống thanh toán. Đó là phần mềm hoàn toàn miễn phí.
...
LiteRouter chỉ định tuyến yêu cầu của bạn đến họ - không có "cạm bẫy" hay thanh toán trong tương lai. Đó là các dịch vụ thực sự miễn phí, và LiteRouter giúp chúng dễ sử dụng với hỗ trợ dự phòng.

**Lưu ý:** số nhà cung cấp gói đăng ký (Antigravity, GitHub Copilot) có thể có các khoảng thời gian dùng thử miễn phí có thể trở thành trả phí sau này, nhưng điều này sẽ được các nhà cung cấp đó thông báo rõ ràng, không phải LiteRouter.
...
3. **Sử dụng nhà cung cấp gói đăng ký cuối cùng:**
   ...
   - LiteRouter giúp tối đa hóa giá trị của chúng thông qua theo dõi hạn mức
...
Cơ chế dự phòng thông minh của LiteRouter ngăn chặn các khoản phí bất ngờ:
...
**Bạn nắm quyền kiểm soát:** Đặt giới hạn chi tiêu cho mỗi nhà cung cấp trong bảng điều khiển, và LiteRouter sẽ tuân thủ chúng.
...
**Mẹo Chuyên nghiệp:** Sử dụng Opus cho các tác vụ phức tạp, Sonnet cho tốc độ. LiteRouter theo dõi hạn mức cho mỗi mô hình!
...
> **Lưu ý:** OpenClaw chỉ hoạt động với LiteRouter cục bộ. Sử dụng `127.0.0.1` thay vì `localhost` để tránh các vấn đề phân giải6.
...
- Runtime LiteRouter cục bộ bao gồm dự phòng SSE→JSON cho các lệnh gọi không phát trực tiếp khi upstream trả về `text/event-stream`.
...
Cảm ơn tất cả những người đã đóng góp giúp LiteRouter tốt hơn!
